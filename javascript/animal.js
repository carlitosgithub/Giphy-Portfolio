var topics = ["dogs", "cats", "rabbit", "hamster", "skunk", "goldfish", "bird", "ferret", "turtle", "sugar glider"];

function displayTopicInfo() {
	var animals = $(this).attr("data-name");
	var queryURL = "https://api.giphy.com/v1/gifs/search?api_key=JbAze3Bq2K81GsPhzV1gSBiyZyA2vR38&q=" + animals + "&limit=10&offset=0&rating=PG-13&lang=en";
